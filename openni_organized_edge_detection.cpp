...
main (int argc, char ** argv)
{
  ...
  std::cout << "Selecciene para habilitar o deshabilitar los diferentes tipos de visualización de bordes:ç" << std::endl;
  std::cout << "<1> Borde: NaN BOUNDARY edge" << std::endl;
  std::cout << "<2> Borde: OCCLUDING" << std::endl;
  std::cout << "<3> Borde: OCCLUDED" << std::endl;
  //std::cout << "<4> Borde: HIGH CURVATURE" << std::endl;
